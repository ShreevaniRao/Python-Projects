Created and coded a Python Jupyter notebook to -

- Demonstrated ETL by extracting csv data from Kaggle dataset containing Order details using Kaggle API url using Kaggle library.
